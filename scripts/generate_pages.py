...
<div class="container">
  ...
  <header>
    <h1><img class="logo" src="assets/Intel_Graphics_logo.png" alt="Intel Graphics">IntelGpu-ComfyUI-Collection<img class="logo-group" src="assets/group_logo_80.png" alt="Group"></h1>
