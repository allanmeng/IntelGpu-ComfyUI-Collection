...
整合包已经将[《IntelGPU的ComfyUI系统优化指南》](https://allanmeng.github.io/IntelGpu-ComfyUI-Collection/intel-comfyui-guide/)包含其中（20260905+），支持 A系列（dg2） 和 B系列（bmg） 显卡的优化，请下载加压后按需选择优化路径。
